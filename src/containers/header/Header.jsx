    ...
    <div className='header section__padding' id="home">
      <div className='header-content'>
        <h1 className='gradient__text'>You're Invited!</h1>
          ...
          <p>"who" : friends, family</p>
          <p>"what" : Nicks ncc graduation celebration</p>
          <p>"when" : Wednesday, May 24th <b>9pm-11pm</b></p>
          <p>"where" : Oceanside, NY <p> </p><a href="https://www.google.com/maps?q=latitude,longitude"> <img className='appleLogo' src={gMapsLogo}></img>Open in Google Maps</a>
